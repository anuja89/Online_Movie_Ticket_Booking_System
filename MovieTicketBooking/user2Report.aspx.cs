...
{
    public partial class user2Report : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "select * from dbo.user2";
                ...
                crp.Load(Server.MapPath("CrystalReportUser.rpt"));
                crp.SetDataSource(ds.Tables["table"]);

                CrystalReportViewer1.ReportSource = crp;
                crp.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "user2Report");
