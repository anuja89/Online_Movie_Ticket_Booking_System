<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DateWiseReport.aspx.cs" Inherits="MovieTicketBooking.DateWiseReport" %>
...
<a href="DateWiseReport.aspx">DateWiseReport.aspx</a>
/* Hover state styling */
...
<body>
    ...
    <div style="margin-top:50px; margin-left:60px;">
        ...
        <div style="margin-top:20px; margin-left:60px;">
            <asp:Label ID="Label2" runat="server" Text="To Date" Font-Bold="True"></asp:Label>
        ...
        <div style="margin-top:40px; margin-left:60px;">
            <asp:Button ID="Button1" runat="server" Text="View Report" OnClick="Button1_Click" Font-Bold="True" />
        </div>
