<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MovieReport.aspx.cs" Inherits="MovieTicketBooking.MovieReport" %>
...
<body>
    ...
    <%-- <div>
        <asp:Button ID="Button1" runat="server" Text="Movie Details" Font-Bold="True" Font-Size="Medium" OnClick="Button1_Click" />
    </div>--%>
        <div>
